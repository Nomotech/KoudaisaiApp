...
window.addEventListener('resize', function(){
  renderer.setSize(window.innerWidth-windowMargine, window.innerHeight-windowMargine );
  camera.aspect = (window.innerWidth-windowMargine) / (window.innerHeight-windowMargine);
  camera.updateProjectionMatrix();
  width = window.innerWidth-windowMargine;
  height = window.innerHeight-windowMargine;
}, false );
